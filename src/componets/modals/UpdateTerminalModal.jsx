...
import { updateTerminal } from "../../services/locationService";

export const UpdateTerminalModal = ({show, onHide, terminalId, data, callBack}) => {
    const [values, setValues] = useState({
      ...
      const handleUpdateTerminal = () => {
        ...
        setSaving(true);
        updateTerminal({ ...values, streetAddress: values.address, terminalId: terminalId })
          .then(async () => {
