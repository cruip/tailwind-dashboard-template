...
import { deleteTrip } from "../../services/busService";

export const DeleteTripModal = ({ show, onHide, id, callBack }) => {
    ...
    return (
        <>
            ...
            <Modal show={show} size="md" onHide={onHide} width='30%'>
                <p>Do you want to Delete this TRip? this is a dangerous operation as this transport companies already have this trip. </p>
