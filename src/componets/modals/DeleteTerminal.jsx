...
import { deleteTerminal } from "../../services/locationService";

export const DeleteTerminalModal = ({ show, onHide, id, callBack }) => {
  ...
  const handleDelete = async (id) => {
    ...
    deleteTerminal(id)
      ...
      .catch(() => toast.error("could not delete Terminal"));
      setSaving(!saving);
  };
  ...
  return (
   <>
    ...
    <p className="mt-6">Do you want to Delete this terminal? this is a dangerous operation </p>
