  ...
  return (
    ...
    { bannerOpen && (
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
        <div className="bg-gray-800 border border-transparent dark:border-gray-700 text-gray-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          ...
          <button className="text-gray-500 hover:text-gray-400 pl-2 ml-3 border-l border-gray-700" onClick={() => setBannerOpen(false) }>
