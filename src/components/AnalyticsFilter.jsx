...
function AnalyticsFilter({ onFilterChange }) {
  ...
  return (
    <div className="sm:flex sm:justify-center sm:items-center mb-8 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
      {/* Right: Inputs */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div className="mt-4 sm:mt-0">
            ...
            <li className="flex items-center">
                <span className="w-4 h-4 bg-green-300 rounded-full mr-2"></span>
